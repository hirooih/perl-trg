 ...
 *
 *	$Id: Gnu.xs,v 1.29 1997-01-08 15:31:41 hayashi Exp $
 *
...

/*
 * constant support functions (generated by h2xs)
 */
static int
not_here(s)
char *s;
...
int arg;
{
	...
	break;
    case 'I':
	if (strEQ(name, "ISFUNC"))
#ifdef ISFUNC
	    return ISFUNC;
#else
	    goto not_there;
#endif
	if (strEQ(name, "ISKMAP"))
#ifdef ISKMAP
	    return ISKMAP;
#else
	    goto not_there;
#endif
	if (strEQ(name, "ISMACR"))
#ifdef ISMACR
	    return ISMACR;
#else
	    goto not_there;
